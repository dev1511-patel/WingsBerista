...
public class AuthServiceClass {
	...
	public Object forgotPassword(ForgotPasswordRequestDTO request) {
		...
		String resetLink ="http://localhost:5500/?token=" + token;
